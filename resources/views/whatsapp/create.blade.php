...
@section('content')
   ...
   <div class="card mt-3">
       <div class="card-header">
           <h1>Send Whatsapp message  to {{ $client->name }}</h1>
       ...
       <div class="card-body">
           <div class="form">
               <form method="POST" action="{{ route('sendwhatsapp', $client->id) }}">
                   @csrf 
                   ...
                   <div class="mb-3">
                       ...
                       <textarea name="message" class="form-control" id="sms" aria-describedby="smsHelp" placeholder="Enter your Whatsapp message here."></textarea>
                   </div>
